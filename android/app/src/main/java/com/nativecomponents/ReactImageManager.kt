...
class ReactImageManager(private val callerContext: ReactApplicationContext) : SimpleViewManager<ReactImageView>() {
    ...
    fun setSource(view: ReactImageView, sources: ReadableArray?) {
